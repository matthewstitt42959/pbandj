...
export function mapDbCharToGame(dbChar) {
  ...
  return {
    ...
    isAI: false,
    species: dbChar.species,
    speciesTrait: dbChar.speciesTrait || null,
    class: dbChar.class,
    subclass: dbChar.subclass || null,
    fightingStyle: dbChar.fightingStyle || null,
    background: dbChar.background,
    backstory: dbChar.backstory || null,
    feats: Array.isArray(dbChar.feats) ? dbChar.feats : [],
    level: dbChar.level,
